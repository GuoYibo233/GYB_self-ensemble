...
def concatenate_paraphrases_with_positions(
    prompts, tokenizer, separator="\n\n[SEP]\n\n"
):
    """
    ...
    def create_patched_forward(self, layer_idx, original_attn):
        ...
        def patched_forward(
            ...
            **kwargs,
            ...
            num_key_value_heads = (
                original_attn.config.num_key_value_heads
            )  # KV heads (for GQA)
            ...
            return (
                attn_output,
                attn_output,
            )  # Return same tensor twice for compatibility
