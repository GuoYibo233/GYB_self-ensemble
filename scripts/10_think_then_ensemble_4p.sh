...
if [ "$DO_SELFPARAPHRASE" = "true" ]; then
    ...
    ENSEMBLE_FILE1=$BASELINE_DATA_ROOT/baseline_per_prompt.0shots.0paras.temp1.0.topp0.95.maxnew2048.repeat4.selfparas.feather
    ENSEMBLE_FILE2=$BASELINE_DATA_ROOT/baseline_per_prompt.0shots.1paras.temp1.0.topp0.95.maxnew2048.repeat2.selfparas.feather
else
    PARAPHRASE_FLAG=""
    ENSEMBLE_FILE1=$BASELINE_DATA_ROOT/baseline_per_prompt.0shots.0paras.temp1.0.topp0.95.maxnew2048.repeat4.feather
    ENSEMBLE_FILE2=$BASELINE_DATA_ROOT/baseline_per_prompt.0shots.1paras.temp1.0.topp0.95.maxnew2048.repeat2.feather
fi
