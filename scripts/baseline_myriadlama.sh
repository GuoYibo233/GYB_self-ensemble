...
echo "Running logits+layer_avg methods on device $DEVICE with $NUM_FEWSHOTS few-shots."
...
for MODEL in llama3.2_3b qwen2.5_3b qwen3_30b pythia_2.8b qwen3_4b; do
