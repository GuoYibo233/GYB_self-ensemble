...
GPU_IDS="4 5 6 7"  # 要使用的GPU ID列表，用空格分隔，如 "0 2 4 6" 或 "0 1 2 3"
FEWSHOTS_LIST="0 5"  # Few-shot数量列表，支持多个值用空格分隔，如 "0 5 10"
DATASETS="commonsense mmlu logiqa"  # 数据集，支持多个用空格分隔，如 "myriadlama commonsense mmlu logiqa hotpot"
MODELS="llama3.2_3b qwen2.5_3b qwen3_4b pythia_2.8b"  # 模型列表，用空格分隔#TODO 30B
# Todo 30b
# Baseline参数配置
BASELINE_METHOD="per_prompt"
...
echo "==============================================="
echo ""
echo "Running ensemble match evaluation with the following configuration:"
